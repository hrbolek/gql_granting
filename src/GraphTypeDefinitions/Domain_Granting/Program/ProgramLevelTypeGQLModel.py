...
class ProgramLevelTypeUpdateGQLModel:
    ...
    name: typing.Optional[str] = strawberry.field(description="name of the program_level_type", default=strawberry.UNSET)
    name_en: typing.Optional[str] = strawberry.field(description="name of the program_level_type", default=strawberry.UNSET)
    length: typing.Optional[int] = strawberry.field(description="length of the program_level_type", default=strawberry.UNSET)
