...
class ExamGQLModel(BaseGQLModel):
    ...
    path: typing.Optional[IDType] = strawberry.field(
...
class ExamMutation:
    ...
    async def exam_insert(
        ...
        if hasattr(planResult, "failed"):
            return InsertError[ExamGQLModel](
                msg=planResult.msg,
                _input=exam
            )
        logging.info(f"Exam insert result: \n{result}, \nplan update result: \n{planResult}") 
        return result
    ...
    @strawberry.mutation(
        ...
        extensions=[
            ...
            LoadDataExtension[UpdateError, ExamGQLModel]()
        ]
    )
    ...
    @strawberry.mutation(
        ...
        extensions=[
            ...
            LoadDataExtension[DeleteError, ExamGQLModel]()
        ]
    )
