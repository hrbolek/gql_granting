...
class EvaluationGQLModel(BaseGQLModel):
    ...
    path: typing.Optional[str] = strawberry.field(
        default=None,
        description="Materialized path technique",
        permission_classes=[
            OnlyForAuthentized
        ]
    )
...
class EvaluationInsertGQLModel(TreeInputStructureMixin):
    ...
    # semester_id: IDType = strawberry.field(description="Which semester / subject is examined", default=None)
    exam_id: IDType = strawberry.field(
...
class EvaluationUpdateGQLModel:
    ...
    semester_id: typing.Optional[IDType] = strawberry.field(description="Which semester / subject is examined", default=strawberry.UNSET)
    user_id: typing.Optional[IDType] = strawberry.field(description="Who is examined", default=strawberry.UNSET)
    order: typing.Optional[int] = strawberry.field(description="index of attempt", default=strawberry.UNSET)
    points: typing.Optional[int] = strawberry.field(description="given points for this exam", default=strawberry.UNSET)
    passed: typing.Optional[bool] = strawberry.field(description="True if student passed this exam", default=strawberry.UNSET)
    description: typing.Optional[str] = strawberry.field(description="description given to student and exam", default=strawberry.UNSET)
    grade: typing.Optional[str] = strawberry.field(description="given grade / mark", default=strawberry.UNSET)
    classificationlevel_id: typing.Optional[IDType] = strawberry.field(description="Formal given grade", default=strawberry.UNSET)
    exam_id: typing.Optional[IDType] = strawberry.field(description="Exam plan", default=strawberry.UNSET)
    event_id: typing.Optional[IDType] = strawberry.field(description="the event when exam happened and evaluation has been stored", default=strawberry.UNSET)
    # parent_id: typing.Optional[IDType] = strawberry.field(description="id of exam which this is part", default=strawberry.UNSET)
    # student_id: typing.Optional[IDType] = strawberry.field(description="id of the student", default=strawberry.UNSET)
    examiner_id: typing.Optional[IDType] = strawberry.field(description="who examined", default=strawberry.UNSET)
    exam_id: typing.Optional[IDType] = strawberry.field(description="related exam conditions", default=strawberry.UNSET)
...
class EvaluationMutation:
    ...
    @strawberry.mutation(
        ...
        extensions=[
            # UpdatePermissionCheckRoleFieldExtension[GroupGQLModel](roles=["administrátor", "personalista"]),
            UserAccessControlExtension[InsertError, EvaluationGQLModel](roles=[
                "studijní administrátor", 
                # "studijní administrátor"
            ]),
    ...
    async def evaluation_delete(
        self, 
        info: strawberry.types.Info, 
        evaluation: EvaluationDeleteGQLModel,
        user_roles: typing.List[dict],
        rbacobject_id: IDType,
        db_row: typing.Any
