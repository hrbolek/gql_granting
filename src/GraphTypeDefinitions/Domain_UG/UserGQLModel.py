...
StudentGQLModel = typing.Annotated["StudentGQLModel", strawberry.lazy("src.GraphTypeDefinitions.Domain_Granting.Student")]
StudentInputFilter = typing.Annotated["StudentInputFilter", strawberry.lazy("src.GraphTypeDefinitions.Domain_Granting.Student")]
